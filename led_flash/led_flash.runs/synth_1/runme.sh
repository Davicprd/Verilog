...
HD_PWD='C:/Users/davic/led_flash/led_flash.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log led_flash.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source led_flash.tcl
