...
HD_PWD='C:/Users/davic/led_flash/led_flash.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log led_flash.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source led_flash.tcl -notrace
