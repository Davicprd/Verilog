...
HD_PWD='C:/Users/davic/First_Project/First_Project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log buff.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source buff.tcl -notrace
