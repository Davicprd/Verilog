...
HD_PWD='C:/Users/davic/First_Project/First_Project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log buff.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source buff.tcl
