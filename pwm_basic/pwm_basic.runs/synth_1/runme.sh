...
HD_PWD='C:/Users/davic/pwm_basic/pwm_basic.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log pwm_led.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source pwm_led.tcl
