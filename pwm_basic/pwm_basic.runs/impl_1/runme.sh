...
HD_PWD='C:/Users/davic/pwm_basic/pwm_basic.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log pwm_led.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source pwm_led.tcl -notrace
