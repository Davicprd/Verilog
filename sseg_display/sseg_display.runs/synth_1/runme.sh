...
HD_PWD='C:/Users/davic/sseg_display/sseg_display.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sseg_test.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sseg_test.tcl
