...
HD_PWD='C:/Users/davic/sseg_display/sseg_display.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log sseg_test.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source sseg_test.tcl -notrace
