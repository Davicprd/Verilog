...
HD_PWD='C:/Users/davic/testeclock/testeclock.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log teste_clock.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source teste_clock.tcl
