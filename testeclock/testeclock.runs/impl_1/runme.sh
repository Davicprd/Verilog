...
HD_PWD='C:/Users/davic/testeclock/testeclock.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log teste_clock.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source teste_clock.tcl -notrace
